...
fn score_issue_from_uiux(issue: UIUXIssue) -> ScoreIssue {
    ScoreIssue {
        ...
        severity: match issue.severity {
            IssueSeverity::Info => lumenx_score::IssueSeverity::Info,
            IssueSeverity::Low => lumenx_score::IssueSeverity::Low,
            IssueSeverity::Medium => lumenx_score::IssueSeverity::Medium,
            IssueSeverity::High => lumenx_score::IssueSeverity::High,
            IssueSeverity::Critical => lumenx_score::IssueSeverity::Critical,
        },
